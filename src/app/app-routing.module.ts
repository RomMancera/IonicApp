...
const routes: Routes = [
  ...
  {
    path: 'loadings',
    loadChildren: () => import('./pages/loadings/loadings.module').then( m => m.LoadingsPageModule)
  },
  {
    path: 'modal-f',
    loadChildren: () => import('./pages/modal-f/modal-f.module').then( m => m.ModalFPageModule)
  },
  {
    path: 'form-load',
    loadChildren: () => import('./pages/form-load/form-load.module').then( m => m.FormLoadPageModule)
  },
  {
    path: 'popover',
